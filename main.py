...
#from UI.consola_2 import run_console_2
...
def main():
    ...
    lista_rezervari.append(creeaza_rezervare(10, 'Alex', 'economy', 92, 'nu'))

    undo_list = []
    redo_list = []
    run_all()
    lista_rezervari = run_console(lista_rezervari, undo_list, redo_list)
